 ...
 * ==============================================================================
 * 合并规则: 每一项覆盖 config.default.js 同名默认值(对象深合并/数组整段替换)。
 * 想恢复某项默认: 从本文件删掉该项即可自动回落。
 *
 * ⚠️ V10.0 结构升级说明(本文件已按新结构全量重生成):
 *   DEVICE 改为【字段独立】结构: FOCUS/SILENT/MEDIA_VOLUME 各一节,各有 OWN 独立时刻表;
 *   新增 STATE_MODE_DEFAULT(默认匹配模式) / POINT / SEGMENT(双模式容差);
 *   新增 EXTERNAL_ALARMS(外部闹钟源: 签到/信用卡等项目时间点直接变手机闹钟)。
 *   若你之前在旧结构里改过 DEVICE 参数,请在下方新结构对应位置重新填写。
 * ============================================================================== */
