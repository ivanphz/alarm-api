/**
 * ==============================================================================
 * 🧑 config.user.js — 你的个人配置层（全量，只有你改，维护者永远不碰）
 * ==============================================================================
 *
 * 合并规则: 这里【每一项】都会覆盖 config.default.js 的同名默认值（深合并）。
 *   · 普通对象 → 逐层深合并  · 数组 → 整段替换（要改数组就写全，便于删项）
 *
 * 本文件已是全量默认参数，你可以直接在这里改任何值:
 *   · 判定时间 / 闹钟时间 / DND 时间 / 寒假日期 / 关键字 / 阈值 / 鉴权开关…
 *   · 改完 git push → Actions 自动部署即生效。
 *
 * 🔌 鉴权开关: 下方 AUTH_DISABLED 字段（默认 false=正常鉴权，true=裸奔）。
 *
 * 提示: 若哪天想"恢复某项默认值"，把该项从本文件删掉即可（会自动回落到 default）。
 * ============================================================================== */

export const USER_CONFIG = {

  // ───────────────────────────────────────────────────────────────────────────
  // 🔌 鉴权开关: false = 正常鉴权(URL 需带 ?key=)；true = 关闭鉴权裸奔(输网址即可)
  // ───────────────────────────────────────────────────────────────────────────
  AUTH_DISABLED: true,
