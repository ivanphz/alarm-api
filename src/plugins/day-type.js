...
//
//   eve      明天上不上班（决定在家时几点进安静）
//     workday | rest       明天实际休息 → 晚点进；否则早点进
//
//   night    今晚人在不在家（决定要不要整体延后）★ 2026-07-31
//     home | away
//     away = 当晚有 work_event 且它覆盖到傍晚（presence.evening === "out"）
//     出差在外 → 一律晚点进安静，早早勿扰没意义。
//     ⚠️ 只看【当晚】: 出差最后一天傍晚已经到家（事件在下午结束）→ 仍是 home，
//        照常按明天上不上班决定 —— 这正是"加一根轴"比"改 ZONES.EVENING"准的地方。
//
