...
export const CONFIG = {
  ...
  //
  // 生命周期（不删除，绕开 iOS 删除闹钟的确认弹窗）:
  //   每次同步: ①查找所有 Gate-Dynamic-Event → 全部【关闭】(静默)
  //             ②按本次 dynamicAlarms 数组新建当天需要的(开启)
  //   过期的旧闹钟以"关闭僵尸"形式留存、不会响，靠手动「大扫除」指令定期清理。
  // ───────────────────────────────────────────────────────────────────────────
  DYNAMIC_LABELS: {
    EVENT: "Gate-Dynamic-Event"   // [覆盖][出差]等有具体时间的工作事件产生的唤醒闹钟
  },
