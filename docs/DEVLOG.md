...
### 2.1【已更正】Turn Focus 无需 priming —— 当年归因错误
- **原记载(错)**：以为 `Turn Focus On/Off` 必须先 Get Current Focus 才生效。
- **更正(2026-07-17 用户实测复核)**：**Turn Focus 本身就能生效，不需要 priming 前置。**
  当年"复杂的行简单的不行"是**别的原因**(变量自我覆盖等，见 2.2)，被误归因成 priming。
...
## 2026-07-17
- 冻结批次改名 v0.7: mode→preset、GateFix/GateDyn、ai→cadence；文档归档 v1、todo 蓝图入库、INDEX 路线图。72 用例全绿。
- 交接文档体系: HANDOFF(防偏移契约)+HORIZON(远期)+todo三层定义+边界双名制。为换对话开发 todo通道/cadence 备。纯文档。
